...
/**
 * ProductConfigurator (final v2)
 *
 * - Sends all products data to Make.com webhook (single payload)
 * - Generates a PDF including category, subcategory and color images for each product
 * - Dynamic accordion titles, India states only, modal with left-image / right-content
 *
 * Required:
 *   npm install jspdf html2canvas
 *
 * Make.com webhook: provided by user
 */
                  ...
                  <tr>
                    ...
                    <td className="p-2">
                      <input
                        ...
                        onChange={(e) =>
                          handlePersonalDetailsChange('phoneNumber', e.target.value)
                        }
