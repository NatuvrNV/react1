...
const Contact = ({ brochureName }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.gtag && window.gtag("event", "conversion", {
        send_to: "AW-16992180594/XQxMCJvBnLkaEPKywKY_", // 🔁 Replace with your actual ID and Label
      });
  ...
  return (
    <>
      <Helmet>
        <title>Download {detectedBrochure}  |   Parametric Facade Design</title>
        <meta
          name="description"
          content={`Unlock the world of parametric architecture and dynamic parametric facades in the ${detectedBrochure} brochure by Metaguise.`}
        />
        <meta
          property="og:title"
          content={`Download ${detectedBrochure}  |   Parametric Facade Design`}
        />
        <meta
